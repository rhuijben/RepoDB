...
public class MinTest
{
    ...
    public void TestSqLiteConnectionMinWithoutExpression()
    {
        using (var connection = new SqliteConnection(Database.ConnectionString))
        {
            ...
            // Act
            var result = connection.Min<MdsCompleteTable>(e => e.ColumnInt,
                (object?)null);
    ...
    public async Task TestSqLiteConnectionMinAsyncWithoutExpression()
    {
        using (var connection = new SqliteConnection(Database.ConnectionString))
        {
            ...
            // Act
            var result = await connection.MinAsync<MdsCompleteTable>(e => e.ColumnInt,
                (object?)null);
    ...
    public void TestSqLiteConnectionMinViaTableNameWithoutExpression()
    {
        using (var connection = new SqliteConnection(Database.ConnectionString))
        {
            ...
            // Act
            var result = connection.Min(ClassMappedNameCache.Get<MdsCompleteTable>(),
    ...
    public async Task TestSqLiteConnectionMinAsyncViaTableNameWithoutExpression()
    {
        using (var connection = new SqliteConnection(Database.ConnectionString))
        {
            ...
            // Act
            var result = await connection.MinAsync(ClassMappedNameCache.Get<MdsCompleteTable>(),
                new Field("ColumnInt", typeof(int)),
                (object?)null);
