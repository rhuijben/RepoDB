...
public static partial class DbConnectionExtension
{
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The sum value of the target field.</returns>
    internal static ValueTask<object> SumAsyncInternal<TEntity>(this IDbConnection connection,
        Field field,
        QueryGroup? where = null,
        int commandTimeout = 0,
        string? traceKey = TraceKeys.Sum,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The sum value of the target field.</returns>
    public static async Task<TResult> SumAsync<TEntity, TResult>(this IDbConnection connection,
        Field field,
        object? where = null,
        string? hints = null,
        int commandTimeout = 0,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The sum value of the target field.</returns>
    internal static ValueTask<TResult> SumAsyncInternal<TEntity, TResult>(this IDbConnection connection,
        Field field,
        QueryGroup? where = null,
        int commandTimeout = 0,
        string? traceKey = TraceKeys.Sum,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The sum value of the target field.</returns>
    internal static ValueTask<object> SumAsyncInternal(this IDbConnection connection,
        string tableName,
        Field field,
        QueryGroup? where = null,
        string? hints = null,
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> object to be used during the asynchronous operation.</param>
    /// <returns>The sum value of the target field.</returns>
    public static async Task<TResult> SumAsync<TResult>(this IDbConnection connection,
        string tableName,
        Field field,
        object? where = null,
        string? hints = null,
