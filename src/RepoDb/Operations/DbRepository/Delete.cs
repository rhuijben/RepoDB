    ...
    where TDbConnection : DbConnection, new()
{
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return connection.Delete(entity: entity,
                hints: hints,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return connection.Delete(where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
                transaction: transaction,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return await connection.DeleteAsync(entity: entity,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
                transaction: transaction,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return await connection.DeleteAsync(where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
                transaction: transaction,
