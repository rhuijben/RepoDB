    ...
    where TDbConnection : DbConnection, new()
{
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return connection.Sum<TEntity>(field: field,
                where: where,
                hints: hints,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return connection.Sum(field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return connection.Sum<TEntity, TResult>(field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return await connection.SumAsync<TEntity>(field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return await connection.SumAsync(field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
        ...
        where TEntity : class
    {
        ...
        {
            // Call the method
            return await connection.SumAsync<TEntity, TResult>(field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
                traceKey: traceKey,
        ...
        IDbTransaction? transaction = null)
    {
        ...
        {
            // Call the method
            return connection.Sum(tableName: tableName,
                field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
        ...
        IDbTransaction? transaction = null)
    {
        ...
        {
            // Call the method
            return connection.Sum<TResult>(tableName: tableName,
                field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            // Call the method
            return await connection.SumAsync(tableName: tableName,
                field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            // Call the method
            return await connection.SumAsync<TResult>(tableName: tableName,
                field: field,
                where: where,
                hints: hints,
                commandTimeout: CommandTimeout ?? 0,
