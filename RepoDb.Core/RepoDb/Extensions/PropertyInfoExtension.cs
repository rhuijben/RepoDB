...
public static class PropertyInfoExtension
{
    ...
    public static DbType? GetDbType(this PropertyInfo propertyInfo) =>
        GetDbType(propertyInfo, propertyInfo.DeclaringType);
    ...
    public static DbType? GetDbType(this PropertyInfo propertyInfo,
        Type declaringType) =>
        TypeMapCache.Get(declaringType, propertyInfo) ??
