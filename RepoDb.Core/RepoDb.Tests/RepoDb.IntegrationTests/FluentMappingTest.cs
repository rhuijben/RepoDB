...
public class FluentMappingTest
{
    ...
    private static void Setup()
    {
        // MappedCompleteTable
        FluentMapper
            .Entity<MappedCompleteTable>()
            .Table("[dbo].[COMPLETETABLE]")
            .Primary(e => e.SessionIdMapped)
            .Column(e => e.SessionIdMapped, "SESSIONID")
            .Column(e => e.ColumnBigIntMapped, "COLUMNBIGINT")
            .Column(e => e.ColumnBitMapped, "COLUMNBIT")
            .Column(e => e.ColumnIntMapped, "COLUMNINT")
            .Column(e => e.ColumnDateTimeMapped, "COLUMNDATETIME")
            .Column(e => e.ColumnDateTime2Mapped, "COLUMNDATETIME2")
            .Column(e => e.ColumnNVarCharMapped, "COLUMNNVARCHAR");

        // MappedCompleteTable
        FluentMapper
            .Entity<MappedIdentityTable>()
            .Table("[sc].[IDENTITYTABLE]")
            .Primary(e => e.IdMapped)
            .Column(e => e.IdMapped, "ID")
            .Column(e => e.RowGuidMapped, "ROWGUID")
            .Column(e => e.ColumnBitMapped, "COLUMNBIT")
            .Column(e => e.ColumnIntMapped, "COLUMNINT")
            .Column(e => e.ColumnDateTimeMapped, "COLUMNDATETIME")
            .Column(e => e.ColumnDateTime2Mapped, "COLUMNDATETIME2")
            .Column(e => e.ColumnFloatMapped, "COLUMNFLOAT")
            .Column(e => e.ColumnNVarCharMapped, "COLUMNNVARCHAR");

        // MappedCompleteTableForKey
        FluentMapper
            .Entity<MappedCompleteTableForKey>()
            .Table("[dbo].[COMPLETETABLE]")
            .Column(e => e.IdMapped, "SESSIONID");
    }
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndDeleteByKey()
    {
        // Setup
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndExistsByKey()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryByKey()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForIdentityViaDynamic()
    {
        // Setup
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForIdentityViaExpression()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForIdentityViaQueryField()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForIdentityViaQueryFields()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForIdentityViaQueryGroup()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForIdentityViaDynamic()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForIdentityViaExpression()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForIdentityViaQueryField()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForIdentityViaQueryFields()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForIdentityViaQueryGroup()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndMergeAndQueryAndQueryForIdentity()
    {
        // Setup
        var entity = GetMappedIdentityTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAllAndQueryAllAndForIdentity()
    {
        // Setup
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAllAndMergeAllAndQueryAllForIdentity()
    {
        // Setup
        var entities = GetMappedIdentityTables().AsList();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForNonIdentityViaDynamic()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForNonIdentityViaExpression()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForNonIdentityViaQueryField()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForNonIdentityViaQueryFields()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndQueryForNonIdentityViaQueryGroup()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForNonIdentityViaDynamic()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForNonIdentityViaExpression()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForNonIdentityViaQueryField()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForNonIdentityViaQueryFields()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndUpdateAndQueryForNonIdentityViaQueryGroup()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAndMergeAndQueryAndQueryForNonIdentity()
    {
        // Setup
        var entity = GetMappedCompleteTable();
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAllAndQueryAllAndForNonIdentity()
    {
        // Setup
    ...
    [TestMethod]
    public void TestSqlConnectionFluentMappingInsertAllAndMergeAllAndQueryAllForNonIdentity()
    {
        // Setup
        var entities = GetMappedCompleteTables().AsList();
