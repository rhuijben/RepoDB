...
public class ExecuteListParameterTest
{
    ...
    [TestMethod]
    public void TestSqlConnectionExecuteQueryWithListParameterAsDynamic()
    {
        // Setup
    ...
    [TestMethod]
    public void TestSqlConnectionExecuteQueryWithListParameterAsExpandoObjectAsDictionary()
    {
        // Setup
        var tables = Helper.CreateIdentityTables(10);
        var values = new List<int?> { 1, 3, 4, 8 };
    ...
    [TestMethod]
    public void TestSqlConnectionExecuteQueryWithListParameterAsQueryField()
    {
        // Setup
        var tables = Helper.CreateIdentityTables(10);
        var values = new List<int?> { 1, 3, 4, 8 };
    ...
    [TestMethod]
    public void TestDbRepositoryExecuteQueryWithListParameterAsDynamic()
    {
        // Setup
        var tables = Helper.CreateIdentityTables(10);
        var values = new List<int?> { 1, 3, 4, 8 };
    ...
    [TestMethod]
    public void TestDbRepositoryExecuteQueryWithListParameterAsExpandoObjectAsDictionary()
    {
        // Setup
        var tables = Helper.CreateIdentityTables(10);
        var values = new List<int?> { 1, 3, 4, 8 };
    ...
    [TestMethod]
    public void TestDbRepositoryExecuteQueryWithListParameterAsQueryField()
    {
        // Setup
        var tables = Helper.CreateIdentityTables(10);
        var values = new List<int?> { 1, 3, 4, 8 };
